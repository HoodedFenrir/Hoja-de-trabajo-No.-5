...
# Lista para almacenar los tiempos de procesamiento de cada proceso
tiempos_procesamiento = []

import matplotlib.pyplot as plt

# Lista para almacenar los tiempos de procesamiento de cada proceso
tiempos_procesamiento = [4, 5, 3, 6, 7, 8, 9, 2, 3, 5]  # Ejemplo de datos

# Al final de la simulación, mostrar la gráfica
plt.hist(tiempos_procesamiento, bins=10, color='blue', edgecolor='black')
plt.xlabel('Tiempo de Procesamiento')
plt.ylabel('Frecuencia')
plt.title('Histograma del Tiempo de Procesamiento de los Procesos')
plt.grid(True)
plt.show()
